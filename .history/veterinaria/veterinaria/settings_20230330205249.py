...
SECRET_KEY = 'django-insecure-w7p0g((ha$2^(bev@tkhu3x40zygr@671ljp%yox89j6ds@h=p'
...
config(
    cloud_name = "fredymamani",
  api_key = "139633694623166",
  api_secret = "XRorv9yF_53esLXN3YDrgEi63nI",
  secure = True
)
