...
def enviar_correo_adjuntos(destinatario, titulo):
    ...
    ruta_definitiva = path.join(ruta, 'utils', 'lapiz.jpg')
    

    with open(ruta_definitiva, 'rb') as archivo:
        print(archivo)
        archivo = MIMEApplication(archivo.read(), Name='lapiz.jpg')

    archivo['Content-Disposition'] = 'attachment; filename="lapiz.jpg"'
