...
SECRET_KEY = 'django-insecure-pt_l$rb^#-e8mp48h=h^nb)px97)d387@5b0rr*#-ktjtr@gl1'
...
# Sirve parmodificar el comportamiento de nuestra libreria DRF

REST_FRAMEWORK = {
    # 'PAGE_SIZE' > PARA INDICAR CUANTOS ELEMENTOS VAMOS ARETORNAR POR CADA PAGINA
    'PAGE_SIZE': 3,
